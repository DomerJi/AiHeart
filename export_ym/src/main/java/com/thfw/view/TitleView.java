...
public class TitleView extends FrameLayout {
    ...
    public TitleView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        View view = inflate(context, R.layout.layout_top_navigation_ym, this);
        initView();
        if (attrs != null) {
            ...
            final int colorBg = ta.getColor(R.styleable.TitleView_tv_background, getResources().getColor(R.color.colorPrimaryYm));
