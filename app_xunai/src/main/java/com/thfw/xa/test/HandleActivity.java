...
public class HandleActivity extends AppCompatActivity {
    ...
    private String KEY_FRONT = "handle_front";
    private String KEY_BACK = "handle_back";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> hashMap = SharePreferenceUtil.getObject("Handle", type);
        if (hashMap != null) {
    ...
    private void initView() {
        ...
        mIvTongueFront = (ImageView) findViewById(R.id.iv_handle_front);
        mIvTongueBack = (ImageView) findViewById(R.id.iv_handle_back);
        ...
        mBtRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NetParams params = NetParams.crete().add("leftHandImgPath", frontImg)
                        .add("rigthHandImgPath", backImg)
                        .add("notifyUrl", "https://tianhe.soulbuddy.cn/test");
                addInfo(GsonUtil.toJson(params));
                RequestBody requestBody = XunAiOkHttp.getBody(params);
                SharePreferenceUtil.setString("Handle", GsonUtil.toJson(mParams));
                XunAiOkHttp.request2(XunAiOkHttp.XUNAI_URL + XunAiOkHttp.XUNAI_HANDLE,
    ...
    private void uploadAvatar(String avatarUrl, String key) {
        ...
        XunAiOkHttp.request(ApiHost.getHost() + "user/pic/upload", factory.build(), new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                if (EmptyUtil.isEmpty(HandleActivity.this)) {
                    return;
                }
