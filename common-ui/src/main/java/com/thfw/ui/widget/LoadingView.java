...
public class LoadingView extends LinearLayout implements ILoading {
    ...
    public void showLoading() {
        ...
        if (mLayoutLoading == null) {
            mLayoutLoading = LayoutInflater.from(getContext()).inflate(R.layout.layout_loading_view, this);
    ...
    public void showEmpty() {
        ...
        if (mLayoutEmpty == null) {
            mLayoutEmpty = LayoutInflater.from(getContext()).inflate(R.layout.layout_load_empty_view, this);
    ...
    public void showFail(Level level, OnClickListener onClickListener) {
        setVisibility(VISIBLE);
        if (mLayoutFail == null) {
            mLayoutFail = LayoutInflater.from(getContext()).inflate(R.layout.layout_load_fail_view, this);
