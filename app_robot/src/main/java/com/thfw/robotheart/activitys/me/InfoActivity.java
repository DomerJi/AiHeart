...
public class InfoActivity extends RobotBaseActivity<UserInfoPresenter> implements UserInfoPresenter.UserInfoUi<User.UserInfo> {
    ...
    private void createLikeDialog() {
        ...
        DialogRobotFactory.createSelectCustomText(this, "兴趣爱好", list, new DialogRobotFactory.OnViewSelectCallBack() {
    ...
    private void createLevelDialog() {
        ...
        DialogRobotFactory.createSelectCustomText(this, "职级", list, new DialogRobotFactory.OnViewSelectCallBack() {
    ...
    private void createNeedDialog() {
        ...
        DialogRobotFactory.createSelectCustomText(this, "需要的支持", list, new DialogRobotFactory.OnViewSelectCallBack() {
