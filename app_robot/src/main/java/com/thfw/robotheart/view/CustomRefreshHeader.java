...
public class CustomRefreshHeader extends ClassicsAbstract<CustomRefreshHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public CustomRefreshHeader(Context context, AttributeSet attrs) {
        ...
        View.inflate(context, R.layout.custom_srl_classics_header, this);
...
//            mLastUpdateText.setTextSize(12);
    ...
    public CustomRefreshHeader setTextSizeTime(int unit, float size) {
