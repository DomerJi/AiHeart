 ...
 * Describe:Todo
 */
public class OrganizationSelectedModel implements IModel {
    ...
    public static class OrganizationBean implements Serializable {
        ...
        private OrganizationBean children;
        ...
        public OrganizationBean getChildren() {
            return children;
        }

        public void setChildren(OrganizationBean children) {
